...
@section('content')
    ...
    <section class="container section" id="services">
        <div class="services">
            <figure class="item">
                <img src="/client/assets/images/static/service-1.png" alt="" class="img">
                <figcaption>
            ...
            <figure class="item">
                <img src="/client/assets/images/static/service-2.png" alt="" class="img">
                <figcaption>
                    <strong class="main-text">Молекулярно-епігенетична оцінка стану організму</strong>
                </figcaption>
            </figure>
            <figure class="item">
                <img src="/client/assets/images/static/service-3.png" alt="" class="img">
                <figcaption>
    ...
    <section id="about" class="section about">
        <div class="container">
            ...
            <article class="article">
                <img src="/client/assets/images/static/about.jpg" alt="" class="img">
                <div class="content">
        ...
        <div class="container">
            ...
            <div class="content">
               <div class="main">
                   ...
                   <div class="list">
                       <h4 class="list-title">Успішно використовується в виявленні та прогнозуванні перебігу таких видів раку як:</h4>
                       <ul class="ul">
                       ...
                       <a href="#" class="btn">дізнатися детальніше</a>
                   </div>
                   <!-- /.list -->
               </div>
               <!-- /.main -->
