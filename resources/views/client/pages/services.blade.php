        ...
        <div class="container">
            ...
            <article class="news-article">
                ...
                <p>Результати аналізу видаються в зручній формі із детально описаним заключенням та найоптимальнішими рекомендаціями!
                    <span class="pink"><b>Вартість дослідження від 3950 грн</b></span>
                </p>
            </article>
            ...
            <article class="news-article">
                ...
                <p style="font-size: 24px"><b>В основі miR-ТЕСТу лежить аналіз <a href="#">мікроРНК</a></b></p>
            ...
            <section class="cards" id="service-list">
                <div class="card card-pink">
                    ...
                    <div class="bottom">від 4200 грн.</div>
                </div>
                <!-- /.card -->
                <div class="card card-pink">
                    <h4 class="header">miR-ТЕСТ «Пані+»</h4>
                    ...
                    <div class="bottom">від 6600 грн.</div>
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    ...
                    <div class="bottom">від 10080 грн.</div>
                </div>
                <!-- /.card -->
            </section>
        </div>
