    ...
    <main class="page" id="services">
        ...
        <div class="container">
            ...
            <article class="news-article">
                ...
                <blockquote>
                    <div>КОЛИ?</div> «ОНКО Drug Test»  проводиться при різних типах раку
                </blockquote>
                <blockquote>
                    <div>КОМУ?</div> «ОНКО Drug Test» проводиться пацієнтам після проходження хіміотерапії для визначення найбільш ефективних наступних курсів лікування
                </blockquote>
