    ...
    <main class="page" id="services">
        ...
        <div class="container">
            ...
            <article class="news-article">
                ...
                <blockquote>
                    <div>WHY?</div> "ONCO Drug Test" is necessary when the next stage of treatment is unclear
                </blockquote>
                <blockquote>
                    <div>WHEN?</div> "ONCO Drug Test" is done for different cancer types
                </blockquote>
                <blockquote>
                    <div>WHO?</div> Patients after chemotherapy can do “ONCO Drug Test” to determine the next most effective course of treatment
                </blockquote>
                ...
                <picture>
                    <source srcset="/client/assets/images/static/s-img-1_tablet-en.jpg" media="(max-width: 830px)">
                    <source srcset="/client/assets/images/static/s-img-1_mobile-en.jpg" media="(max-width: 555px)">
            ...
            <picture>
                <source srcset="/client/assets/images/static/s-img-2_tablet-en.jpg" media="(max-width: 830px)">
                <source srcset="/client/assets/images/static/s-img-2_mobile-en.jpg" media="(max-width: 555px)">
                <img src="/client/assets/images/static/s-img-2-en.jpg" alt="Principles and benefits" style="max-width: 100%">
            </picture>
            ...
            <article class="news-article">
                ...
                <blockquote>
                    <div>Why?</div>
                    If you have doubts about the intensity, suitability and "efficacy" of antitumor medicines that you use or intend using, we will conduct the analysis of their biological activity using specially designed sensitive test systems <em>in vitro</em>
                </blockquote>
                <blockquote>
                    <div>Who?</div>
                    Patients who value their health and want to ensure the high quality of treatment medication <br/>
