<footer class="footer" id="footer">
            ...
            <form action="{{route('client.feedback.store')}}" id="feedback-form" method="post">
                <div class="row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="footer-name" name="fullname" required placeholder="Name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="footer-email" name="email" placeholder="your@email.com">
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" rows="4" id="footer-text" name="message" maxlength="1000" placeholder=".."></textarea>
                    </div>
                </div>
    ...
    <div class="map" id="map">
        ...
        <div class="container text-right">
            <button type="submit" class="btn js-open-map">Hide map</button>
        </div>
    </div>
    <!-- /.map -->
